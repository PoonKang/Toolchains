...
enum opt_code
{
  ...
  OPT_mcallee_super_interworking = 1061,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1062,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1063,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1064,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1065,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1066,                  /* -mfp16-format= */
  OPT_mfpu_ = 1067,                          /* -mfpu= */
  /* OPT_mhard_float = 1068, */              /* -mhard-float */
  OPT_mlittle_endian = 1069,                 /* -mlittle-endian */
  OPT_mlong_calls = 1070,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1071,               /* -mneon-for-64bits */
  OPT_mpic_register_ = 1072,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1073,            /* -mpoke-function-name */
  OPT_mrestrict_it = 1074,                   /* -mrestrict-it */
  OPT_msched_prolog = 1075,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1076,               /* -msingle-pic-base */
  /* OPT_msoft_float = 1077, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1078,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1079,                         /* -mthumb */
  OPT_mthumb_interwork = 1080,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1081,                  /* -mtls-dialect= */
  OPT_mtp_ = 1082,                           /* -mtp= */
  OPT_mtpcs_frame = 1083,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1084,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1085,                         /* -mtune= */
  OPT_munaligned_access = 1086,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1087,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1088,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1089,              /* -mword-relocations */
  OPT_mwords_little_endian = 1090,           /* -mwords-little-endian */
  OPT_n = 1091,                              /* -n */
  OPT_no_canonical_prefixes = 1092,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1093,              /* -no-integrated-cpp */
  OPT_nocpp = 1094,                          /* -nocpp */
  OPT_nodefaultlibs = 1095,                  /* -nodefaultlibs */
  ...
  OPT_print_multiarch = 1113,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1114,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1115,               /* -print-prog-name= */
  OPT_print_search_dirs = 1116,              /* -print-search-dirs */
  OPT_print_sysroot = 1117,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1118,   /* -print-sysroot-headers-suffix */
