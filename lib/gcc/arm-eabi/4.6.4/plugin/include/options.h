...
enum opt_code
{
  ...
  OPT_munaligned_access = 980,               /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 981,     /* -mvectorize-with-neon-double */
  ...
  OPT_o = 994,                               /* -o */
  OPT_p = 995,                               /* -p */
  OPT_pass_exit_codes = 996,                 /* -pass-exit-codes */
  OPT_pedantic = 997,                        /* -pedantic */
  OPT_pedantic_errors = 998,                 /* -pedantic-errors */
  OPT_pg = 999,                              /* -pg */
  OPT_pie = 1000,                            /* -pie */
  OPT_pipe = 1001,                           /* -pipe */
  OPT_print_file_name_ = 1002,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1003,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1004,          /* -print-multi-directory */
  OPT_print_multi_lib = 1005,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1006,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1007,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1008,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1009,               /* -print-prog-name= */
  OPT_print_search_dirs = 1010,              /* -print-search-dirs */
  OPT_print_sysroot = 1011,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1012,   /* -print-sysroot-headers-suffix */
  OPT_quiet = 1013,                          /* -quiet */
  OPT_r = 1014,                              /* -r */
  OPT_remap = 1015,                          /* -remap */
  OPT_s = 1016,                              /* -s */
  OPT_s_bc_abi = 1017,                       /* -s-bc-abi */
  OPT_save_temps = 1018,                     /* -save-temps */
  OPT_save_temps_ = 1019,                    /* -save-temps= */
  OPT_shared = 1020,                         /* -shared */
  OPT_shared_libgcc = 1021,                  /* -shared-libgcc */
  /* OPT_specs = 1022, */                    /* -specs */
  OPT_specs_ = 1023,                         /* -specs= */
  OPT_static = 1024,                         /* -static */
  OPT_static_libgcc = 1025,                  /* -static-libgcc */
  OPT_static_libgcj = 1026,                  /* -static-libgcj */
  OPT_static_libgfortran = 1027,             /* -static-libgfortran */
  OPT_static_libgo = 1028,                   /* -static-libgo */
  OPT_static_libstdc__ = 1029,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1030, */                /* -std=c++03 */
  OPT_std_c__0x = 1031,                      /* -std=c++0x */
  OPT_std_c__98 = 1032,                      /* -std=c++98 */
  OPT_std_c1x = 1033,                        /* -std=c1x */
  /* OPT_std_c89 = 1034, */                  /* -std=c89 */
  OPT_std_c90 = 1035,                        /* -std=c90 */
  OPT_std_c99 = 1036,                        /* -std=c99 */
  /* OPT_std_c9x = 1037, */                  /* -std=c9x */
  OPT_std_f2003 = 1038,                      /* -std=f2003 */
  OPT_std_f2008 = 1039,                      /* -std=f2008 */
  OPT_std_f95 = 1040,                        /* -std=f95 */
  OPT_std_gnu = 1041,                        /* -std=gnu */
  OPT_std_gnu__0x = 1042,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1043,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1044,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1045, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1046,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1047,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1048, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1049, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1050,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1051, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1052, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1053,                     /* -std=legacy */
  OPT_symbolic = 1054,                       /* -symbolic */
  OPT_t = 1055,                              /* -t */
  OPT_time = 1056,                           /* -time */
  OPT_time_ = 1057,                          /* -time= */
