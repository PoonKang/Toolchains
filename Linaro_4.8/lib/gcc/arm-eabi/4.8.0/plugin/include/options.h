...
enum opt_code
{
  ...
  OPT_faggressive_loop_optimizations = 439,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 440,                  /* -falign-commons */
  OPT_falign_functions = 441,                /* -falign-functions */
  OPT_falign_functions_ = 442,               /* -falign-functions= */
  OPT_falign_jumps = 443,                    /* -falign-jumps */
  OPT_falign_jumps_ = 444,                   /* -falign-jumps= */
  OPT_falign_labels = 445,                   /* -falign-labels */
  OPT_falign_labels_ = 446,                  /* -falign-labels= */
  OPT_falign_loops = 447,                    /* -falign-loops */
  OPT_falign_loops_ = 448,                   /* -falign-loops= */
  OPT_fall_intrinsics = 449,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 450, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 451,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 452,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 453, */   /* -falt-external-templates */
  /* OPT_fargument_alias = 454, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 455, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 456, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 457, */  /* -fargument-noalias-global */
  OPT_fasm = 458,                            /* -fasm */
  OPT_fassert = 459,                         /* -fassert */
  OPT_fassociative_math = 460,               /* -fassociative-math */
  OPT_fassume_compiled = 461,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 462,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 463,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 464,                   /* -fauto-inc-dec */
  OPT_fautomatic = 465,                      /* -fautomatic */
  OPT_faux_classpath = 466,                  /* -faux-classpath */
  OPT_fbackslash = 467,                      /* -fbackslash */
  OPT_fbacktrace = 468,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 469,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 470,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 471,              /* -fbootstrap-classes */
  OPT_fbounds_check = 472,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 473,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 474,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 475,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 476,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 477,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 478,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 479,                        /* -fbuiltin */
  OPT_fbuiltin_ = 480,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 481,                    /* -fcall-saved- */
  OPT_fcall_used_ = 482,                     /* -fcall-used- */
  OPT_fcaller_saves = 483,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 484,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 485,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 486,                /* -fcheck-data-deps */
  OPT_fcheck_new = 487,                      /* -fcheck-new */
  OPT_fcheck_references = 488,               /* -fcheck-references */
  OPT_fcheck_ = 489,                         /* -fcheck= */
  OPT_fclasspath_ = 490,                     /* -fclasspath= */
  OPT_fcoarray_ = 491,                       /* -fcoarray= */
  OPT_fcombine_stack_adjustments = 492,      /* -fcombine-stack-adjustments */
  OPT_fcommon = 493,                         /* -fcommon */
  OPT_fcompare_debug = 494,                  /* -fcompare-debug */
  OPT_fcompare_debug_second = 495,           /* -fcompare-debug-second */
  OPT_fcompare_debug_ = 496,                 /* -fcompare-debug= */
  OPT_fcompare_elim = 497,                   /* -fcompare-elim */
  OPT_fcompile_resource_ = 498,              /* -fcompile-resource= */
  OPT_fcond_mismatch = 499,                  /* -fcond-mismatch */
  OPT_fconserve_space = 500,                 /* -fconserve-space */
  OPT_fconserve_stack = 501,                 /* -fconserve-stack */
  OPT_fconstant_string_class_ = 502,         /* -fconstant-string-class= */
  OPT_fconstexpr_depth_ = 503,               /* -fconstexpr-depth= */
  OPT_fconvert_big_endian = 504,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 505,          /* -fconvert=little-endian */
  OPT_fconvert_native = 506,                 /* -fconvert=native */
  OPT_fconvert_swap = 507,                   /* -fconvert=swap */
  OPT_fcprop_registers = 508,                /* -fcprop-registers */
  OPT_fcray_pointer = 509,                   /* -fcray-pointer */
  OPT_fcrossjumping = 510,                   /* -fcrossjumping */
  OPT_fcse_follow_jumps = 511,               /* -fcse-follow-jumps */
  /* OPT_fcse_skip_blocks = 512, */          /* -fcse-skip-blocks */
  OPT_fcx_fortran_rules = 513,               /* -fcx-fortran-rules */
  OPT_fcx_limited_range = 514,               /* -fcx-limited-range */
  OPT_fd_lines_as_code = 515,                /* -fd-lines-as-code */
  OPT_fd_lines_as_comments = 516,            /* -fd-lines-as-comments */
  OPT_fdata_sections = 517,                  /* -fdata-sections */
  OPT_fdbg_cnt_list = 518,                   /* -fdbg-cnt-list */
  OPT_fdbg_cnt_ = 519,                       /* -fdbg-cnt= */
  OPT_fdce = 520,                            /* -fdce */
  OPT_fdebug_cpp = 521,                      /* -fdebug-cpp */
  OPT_fdebug_prefix_map_ = 522,              /* -fdebug-prefix-map= */
  OPT_fdebug_types_section = 523,            /* -fdebug-types-section */
  OPT_fdeduce_init_list = 524,               /* -fdeduce-init-list */
  OPT_fdefault_double_8 = 525,               /* -fdefault-double-8 */
  /* OPT_fdefault_inline = 526, */           /* -fdefault-inline */
  OPT_fdefault_integer_8 = 527,              /* -fdefault-integer-8 */
  OPT_fdefault_real_8 = 528,                 /* -fdefault-real-8 */
  OPT_fdefer_pop = 529,                      /* -fdefer-pop */
  OPT_fdelayed_branch = 530,                 /* -fdelayed-branch */
  OPT_fdelete_dead_exceptions = 531,         /* -fdelete-dead-exceptions */
  OPT_fdelete_null_pointer_checks = 532,     /* -fdelete-null-pointer-checks */
  OPT_fdevirtualize = 533,                   /* -fdevirtualize */
  OPT_fdiagnostics_show_caret = 534,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 535,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 536,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 537,                /* -fdirectives-only */
  OPT_fdisable_ = 538,                       /* -fdisable- */
  OPT_fdisable_assertions = 539,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 540,            /* -fdisable-assertions= */
  OPT_fdollar_ok = 541,                      /* -fdollar-ok */
  OPT_fdollars_in_identifiers = 542,         /* -fdollars-in-identifiers */
  OPT_fdse = 543,                            /* -fdse */
  OPT_fdump_ = 544,                          /* -fdump- */
  OPT_fdump_ada_spec = 545,                  /* -fdump-ada-spec */
  OPT_fdump_ada_spec_slim = 546,             /* -fdump-ada-spec-slim */
  /* OPT_fdump_core = 547, */                /* -fdump-core */
  OPT_fdump_final_insns = 548,               /* -fdump-final-insns */
  OPT_fdump_final_insns_ = 549,              /* -fdump-final-insns= */
  OPT_fdump_fortran_optimized = 550,         /* -fdump-fortran-optimized */
  OPT_fdump_fortran_original = 551,          /* -fdump-fortran-original */
  OPT_fdump_go_spec_ = 552,                  /* -fdump-go-spec= */
  OPT_fdump_noaddr = 553,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 554,                /* -fdump-parse-tree */
  OPT_fdump_passes = 555,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 556,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 557,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 558,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 559,                 /* -fearly-inlining */
  OPT_felide_constructors = 560,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 561,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 562, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 563,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 564,        /* -femit-class-debug-always */
  OPT_femit_class_file = 565,                /* -femit-class-file */
  OPT_femit_class_files = 566,               /* -femit-class-files */
  OPT_femit_struct_debug_baseonly = 567,     /* -femit-struct-debug-baseonly */
  OPT_femit_struct_debug_detailed_ = 568,    /* -femit-struct-debug-detailed= */
  OPT_femit_struct_debug_reduced = 569,      /* -femit-struct-debug-reduced */
  OPT_fenable_ = 570,                        /* -fenable- */
  OPT_fenable_assertions = 571,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 572,             /* -fenable-assertions= */
  OPT_fencoding_ = 573,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 574,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 575, */           /* -fenum-int-equiv */
  OPT_fexceptions = 576,                     /* -fexceptions */
  OPT_fexcess_precision_ = 577,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 578,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 579,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 580,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 581,                       /* -fextdirs= */
  OPT_fextended_identifiers = 582,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 583,                /* -fextern-tls-init */
  OPT_fexternal_blas = 584,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 585, */       /* -fexternal-templates */
  OPT_ff2c = 586,                            /* -ff2c */
  OPT_ffast_math = 587,                      /* -ffast-math */
  OPT_ffat_lto_objects = 588,                /* -ffat-lto-objects */
  ...
  OPT_ffrontend_optimize = 607,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 608,                   /* -ffunction-cse */
  OPT_ffunction_sections = 609,              /* -ffunction-sections */
  OPT_fgcse = 610,                           /* -fgcse */
  OPT_fgcse_after_reload = 611,              /* -fgcse-after-reload */
  OPT_fgcse_las = 612,                       /* -fgcse-las */
  OPT_fgcse_lm = 613,                        /* -fgcse-lm */
  OPT_fgcse_sm = 614,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 615,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 616,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 617,                         /* -fgnu-tm */
  OPT_fgnu89_inline = 618,                   /* -fgnu89-inline */
  OPT_fgo_check_divide_overflow = 619,       /* -fgo-check-divide-overflow */
  OPT_fgo_check_divide_zero = 620,           /* -fgo-check-divide-zero */
  OPT_fgo_dump_ = 621,                       /* -fgo-dump- */
  OPT_fgo_optimize_ = 622,                   /* -fgo-optimize- */
  OPT_fgo_pkgpath_ = 623,                    /* -fgo-pkgpath= */
  OPT_fgo_prefix_ = 624,                     /* -fgo-prefix= */
  OPT_fgo_relative_import_path_ = 625,       /* -fgo-relative-import-path= */
  OPT_fgraphite = 626,                       /* -fgraphite */
  OPT_fgraphite_identity = 627,              /* -fgraphite-identity */
  OPT_fguess_branch_probability = 628,       /* -fguess-branch-probability */
  /* OPT_fguiding_decls = 629, */            /* -fguiding-decls */
  /* OPT_fhandle_exceptions = 630, */        /* -fhandle-exceptions */
  OPT_fhash_synchronization = 631,           /* -fhash-synchronization */
  /* OPT_fhelp = 632, */                     /* -fhelp */
  /* OPT_fhelp_ = 633, */                    /* -fhelp= */
  OPT_fhoist_adjacent_loads = 634,           /* -fhoist-adjacent-loads */
  /* OPT_fhonor_std = 635, */                /* -fhonor-std */
  OPT_fhosted = 636,                         /* -fhosted */
  /* OPT_fhuge_objects = 637, */             /* -fhuge-objects */
  OPT_fident = 638,                          /* -fident */
  OPT_fif_conversion = 639,                  /* -fif-conversion */
  OPT_fif_conversion2 = 640,                 /* -fif-conversion2 */
  OPT_fimplement_inlines = 641,              /* -fimplement-inlines */
  OPT_fimplicit_inline_templates = 642,      /* -fimplicit-inline-templates */
  OPT_fimplicit_none = 643,                  /* -fimplicit-none */
  OPT_fimplicit_templates = 644,             /* -fimplicit-templates */
  OPT_findirect_classes = 645,               /* -findirect-classes */
  OPT_findirect_dispatch = 646,              /* -findirect-dispatch */
  OPT_findirect_inlining = 647,              /* -findirect-inlining */
  ...
  OPT_finline_atomics = 655,                 /* -finline-atomics */
  OPT_finline_functions = 656,               /* -finline-functions */
  OPT_finline_functions_called_once = 657,   /* -finline-functions-called-once */
  /* OPT_finline_limit_ = 658, */            /* -finline-limit- */
  OPT_finline_limit_ = 659,                  /* -finline-limit= */
  OPT_finline_small_functions = 660,         /* -finline-small-functions */
  OPT_finput_charset_ = 661,                 /* -finput-charset= */
  OPT_finstrument_functions = 662,           /* -finstrument-functions */
  OPT_finstrument_functions_exclude_file_list_ = 663,/* -finstrument-functions-exclude-file-list= */
  OPT_finstrument_functions_exclude_function_list_ = 664,/* -finstrument-functions-exclude-function-list= */
  OPT_finteger_4_integer_8 = 665,            /* -finteger-4-integer-8 */
  OPT_fintrinsic_modules_path = 666,         /* -fintrinsic-modules-path */
  OPT_fintrinsic_modules_path_ = 667,        /* -fintrinsic-modules-path= */
  OPT_fipa_cp = 668,                         /* -fipa-cp */
  OPT_fipa_cp_clone = 669,                   /* -fipa-cp-clone */
  /* OPT_fipa_matrix_reorg = 670, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 671,                    /* -fipa-profile */
  OPT_fipa_pta = 672,                        /* -fipa-pta */
  OPT_fipa_pure_const = 673,                 /* -fipa-pure-const */
  OPT_fipa_reference = 674,                  /* -fipa-reference */
  OPT_fipa_sra = 675,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 676, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 677,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 678,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 679,              /* -fira-loop-pressure */
  OPT_fira_region_ = 680,                    /* -fira-region= */
  OPT_fira_share_save_slots = 681,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 682,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 683,                   /* -fira-verbose= */
  OPT_fivopts = 684,                         /* -fivopts */
  OPT_fjni = 685,                            /* -fjni */
  OPT_fjump_tables = 686,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 687,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 688,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 689,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 690, */                /* -flabels-ok */
  OPT_flax_vector_conversions = 691,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 692,             /* -fleading-underscore */
  OPT_floop_block = 693,                     /* -floop-block */
  /* OPT_floop_flatten = 694, */             /* -floop-flatten */
  OPT_floop_interchange = 695,               /* -floop-interchange */
  OPT_floop_nest_optimize = 696,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 697, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 698,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 699,                /* -floop-strip-mine */
  OPT_flto = 700,                            /* -flto */
  OPT_flto_compression_level_ = 701,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 702,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 703,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 704,              /* -flto-partition=max */
  OPT_flto_partition_none = 705,             /* -flto-partition=none */
  OPT_flto_report = 706,                     /* -flto-report */
  OPT_flto_ = 707,                           /* -flto= */
  OPT_fltrans = 708,                         /* -fltrans */
  OPT_fltrans_output_list_ = 709,            /* -fltrans-output-list= */
  OPT_fmain_ = 710,                          /* -fmain= */
  OPT_fmath_errno = 711,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 712,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 713,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 714,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 715,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 716,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 717,                     /* -fmem-report */
  OPT_fmem_report_wpa = 718,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 719,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 720,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 721,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 722,                /* -fmessage-length= */
  OPT_fmodule_private = 723,                 /* -fmodule-private */
  OPT_fmodulo_sched = 724,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 725,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 726,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 727,                  /* -fms-extensions */
  OPT_fmudflap = 728,                        /* -fmudflap */
  OPT_fmudflapir = 729,                      /* -fmudflapir */
  OPT_fmudflapth = 730,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 731, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 732, */                  /* -fnew-abi */
  OPT_fnext_runtime = 733,                   /* -fnext-runtime */
  OPT_fnil_receivers = 734,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 735,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 736,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 737, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 738,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 739,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 740,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 741,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 742,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 743,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 744,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 745,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 746,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 747,             /* -fomit-frame-pointer */
  OPT_fopenmp = 748,                         /* -fopenmp */
  OPT_foperator_names = 749,                 /* -foperator-names */
  OPT_fopt_info = 750,                       /* -fopt-info */
  OPT_fopt_info_ = 751,                      /* -fopt-info- */
  OPT_foptimize_register_move = 752,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 753,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 754,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 755,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 756, */           /* -foptional-diags */
  OPT_foutput_class_dir_ = 757,              /* -foutput-class-dir= */
  OPT_fpack_derived = 758,                   /* -fpack-derived */
  OPT_fpack_struct = 759,                    /* -fpack-struct */
  OPT_fpack_struct_ = 760,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 761,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 762,              /* -fpcc-struct-return */
  OPT_fpch_deps = 763,                       /* -fpch-deps */
  OPT_fpch_preprocess = 764,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 765,                     /* -fpeel-loops */
  OPT_fpeephole = 766,                       /* -fpeephole */
  OPT_fpeephole2 = 767,                      /* -fpeephole2 */
  OPT_fpermissive = 768,                     /* -fpermissive */
  OPT_fpic = 769,                            /* -fpic */
  OPT_fpie = 770,                            /* -fpie */
  OPT_fplan9_extensions = 771,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 772,                    /* -fplugin-arg- */
  OPT_fplugin_ = 773,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 774,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 775,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 776,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 777,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 778,                   /* -fpreprocessed */
  OPT_fpretty_templates = 779,               /* -fpretty-templates */
  OPT_fprofile = 780,                        /* -fprofile */
  OPT_fprofile_arcs = 781,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 782,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 783,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 784,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 785,              /* -fprofile-generate= */
  OPT_fprofile_report = 786,                 /* -fprofile-report */
  OPT_fprofile_use = 787,                    /* -fprofile-use */
  OPT_fprofile_use_ = 788,                   /* -fprofile-use= */
  OPT_fprofile_values = 789,                 /* -fprofile-values */
  OPT_fprotect_parens = 790,                 /* -fprotect-parens */
  OPT_frandom_seed = 791,                    /* -frandom-seed */
  OPT_frandom_seed_ = 792,                   /* -frandom-seed= */
  OPT_frange_check = 793,                    /* -frange-check */
  OPT_freal_4_real_10 = 794,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 795,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 796,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 797,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 798,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 799,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 800,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 801,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 802,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 803,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 804,                /* -frecord-marker=8 */
  OPT_frecursive = 805,                      /* -frecursive */
  OPT_freduced_reflection = 806,             /* -freduced-reflection */
  OPT_free = 807,                            /* -free */
  OPT_freg_struct_return = 808,              /* -freg-struct-return */
  OPT_fregmove = 809,                        /* -fregmove */
  OPT_frename_registers = 810,               /* -frename-registers */
  OPT_freorder_blocks = 811,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 812,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 813,              /* -freorder-functions */
  OPT_frepack_arrays = 814,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 815,           /* -freplace-objc-classes */
  OPT_frepo = 816,                           /* -frepo */
  OPT_frequire_return_statement = 817,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 818,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 819, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 820,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 821,                    /* -fresolution= */
  OPT_frounding_math = 822,                  /* -frounding-math */
  OPT_frtti = 823,                           /* -frtti */
  OPT_fsanitize_address = 824,               /* -fsanitize=address */
  OPT_fsanitize_thread = 825,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 826,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 827,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 828,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 829,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 830,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 831,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 832,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 833,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 834,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 835,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 836,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 837,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 838,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 839,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 840,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 841,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 842,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 843,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 844, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 845,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 846,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 847,              /* -fsecond-underscore */
  OPT_fsection_anchors = 848,                /* -fsection-anchors */
  /* OPT_fsee = 849, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 850,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 851,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 852, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 853,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 854,          /* -fselective-scheduling2 */
  OPT_fshort_double = 855,                   /* -fshort-double */
  OPT_fshort_enums = 856,                    /* -fshort-enums */
  OPT_fshort_wchar = 857,                    /* -fshort-wchar */
  OPT_fshow_column = 858,                    /* -fshow-column */
  OPT_fshrink_wrap = 859,                    /* -fshrink-wrap */
  OPT_fsign_zero = 860,                      /* -fsign-zero */
  OPT_fsignaling_nans = 861,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 862,               /* -fsigned-bitfields */
  OPT_fsigned_char = 863,                    /* -fsigned-char */
  OPT_fsigned_zeros = 864,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 865,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 866,               /* -fsource-filename= */
  OPT_fsource_ = 867,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 868,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 869,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 870,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 871, */                 /* -fsquangle */
  OPT_fstack_arrays = 872,                   /* -fstack-arrays */
  /* OPT_fstack_check = 873, */              /* -fstack-check */
  OPT_fstack_check_ = 874,                   /* -fstack-check= */
  OPT_fstack_limit = 875,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 876,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 877,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 878,                /* -fstack-protector */
  OPT_fstack_protector_all = 879,            /* -fstack-protector-all */
  OPT_fstack_reuse_ = 880,                   /* -fstack-reuse= */
  OPT_fstack_usage = 881,                    /* -fstack-usage */
  OPT_fstats = 882,                          /* -fstats */
  OPT_fstore_check = 883,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 884, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 885,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 886,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 887,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 888, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 889,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 890,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 891,                    /* -fsyntax-only */
  OPT_ftabstop_ = 892,                       /* -ftabstop= */
  /* OPT_ftarget_help = 893, */              /* -ftarget-help */
  OPT_ftarget_ = 894,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 895,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 896, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 897,                /* -ftemplate-depth= */
  OPT_ftest_coverage = 898,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 899, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 900,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 901,             /* -fthreadsafe-statics */
  OPT_ftime_report = 902,                    /* -ftime-report */
  OPT_ftls_model_ = 903,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 904,               /* -ftoplevel-reorder */
  OPT_ftracer = 905,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 906,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 907,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 908,                  /* -ftrapping-math */
  OPT_ftrapv = 909,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 910,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 911,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 912,                       /* -ftree-ccp */
  OPT_ftree_ch = 913,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 914,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 915,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 916,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 917,                /* -ftree-copyrename */
  OPT_ftree_cselim = 918,                    /* -ftree-cselim */
  OPT_ftree_dce = 919,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 920,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 921,                       /* -ftree-dse */
  OPT_ftree_forwprop = 922,                  /* -ftree-forwprop */
  OPT_ftree_fre = 923,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 924,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 925,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 926,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 927,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 928,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 929,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 930, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 931,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 932,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 933,        /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 934,               /* -ftree-partial-pre */
  OPT_ftree_phiprop = 935,                   /* -ftree-phiprop */
  OPT_ftree_pre = 936,                       /* -ftree-pre */
  OPT_ftree_pta = 937,                       /* -ftree-pta */
  OPT_ftree_reassoc = 938,                   /* -ftree-reassoc */
  /* OPT_ftree_salias = 939, */              /* -ftree-salias */
  OPT_ftree_scev_cprop = 940,                /* -ftree-scev-cprop */
  OPT_ftree_sink = 941,                      /* -ftree-sink */
  OPT_ftree_slp_vectorize = 942,             /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 943,                      /* -ftree-slsr */
  OPT_ftree_sra = 944,                       /* -ftree-sra */
  /* OPT_ftree_store_ccp = 945, */           /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 946, */     /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 947,         /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 948,                /* -ftree-tail-merge */
  OPT_ftree_ter = 949,                       /* -ftree-ter */
  OPT_ftree_vect_loop_version = 950,         /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 951,                 /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 952,       /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 953,                       /* -ftree-vrp */
  OPT_funderscoring = 954,                   /* -funderscoring */
  OPT_funit_at_a_time = 955,                 /* -funit-at-a-time */
  OPT_funroll_all_loops = 956,               /* -funroll-all-loops */
  OPT_funroll_loops = 957,                   /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 958,      /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 959,      /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 960,             /* -funsigned-bitfields */
  OPT_funsigned_char = 961,                  /* -funsigned-char */
  OPT_funswitch_loops = 962,                 /* -funswitch-loops */
  OPT_funwind_tables = 963,                  /* -funwind-tables */
  OPT_fuse_atomic_builtins = 964,            /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 965,                   /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 966,                 /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 967,      /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 968,          /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 969,                     /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 970,                    /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 971,              /* -fuse-linker-plugin */
  OPT_fvar_tracking = 972,                   /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 973,       /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 974,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 975,            /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 976, /* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 977,                /* -fvect-cost-model */
  OPT_fverbose_asm = 978,                    /* -fverbose-asm */
  /* OPT_fversion = 979, */                  /* -fversion */
  OPT_fvisibility_inlines_hidden = 980,      /* -fvisibility-inlines-hidden */
  OPT_fvisibility_ms_compat = 981,           /* -fvisibility-ms-compat */
  OPT_fvisibility_ = 982,                    /* -fvisibility= */
  OPT_fvpt = 983,                            /* -fvpt */
  /* OPT_fvtable_gc = 984, */                /* -fvtable-gc */
  /* OPT_fvtable_thunks = 985, */            /* -fvtable-thunks */
  OPT_fweak = 986,                           /* -fweak */
  OPT_fweb = 987,                            /* -fweb */
  OPT_fwhole_file = 988,                     /* -fwhole-file */
  OPT_fwhole_program = 989,                  /* -fwhole-program */
  OPT_fwide_exec_charset_ = 990,             /* -fwide-exec-charset= */
  OPT_fworking_directory = 991,              /* -fworking-directory */
  OPT_fwpa = 992,                            /* -fwpa */
  OPT_fwrapv = 993,                          /* -fwrapv */
  /* OPT_fxref = 994, */                     /* -fxref */
  /* OPT_fzee = 995, */                      /* -fzee */
  OPT_fzero_initialized_in_bss = 996,        /* -fzero-initialized-in-bss */
  OPT_fzero_link = 997,                      /* -fzero-link */
  OPT_g = 998,                               /* -g */
  OPT_gant = 999,                            /* -gant */
  OPT_gcoff = 1000,                          /* -gcoff */
  OPT_gdwarf_ = 1001,                        /* -gdwarf- */
  OPT_gen_decls = 1002,                      /* -gen-decls */
  OPT_ggdb = 1003,                           /* -ggdb */
  OPT_gnat = 1004,                           /* -gnat */
  OPT_gnatO = 1005,                          /* -gnatO */
  OPT_gno_pubnames = 1006,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1007,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1008,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1009,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1010,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1011,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1012,                   /* -gsplit-dwarf */
  OPT_gstabs = 1013,                         /* -gstabs */
  OPT_gstabs_ = 1014,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1015,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1016,                        /* -gtoggle */
  OPT_gvms = 1017,                           /* -gvms */
  OPT_gxcoff = 1018,                         /* -gxcoff */
  OPT_gxcoff_ = 1019,                        /* -gxcoff+ */
  OPT_h = 1020,                              /* -h */
  OPT_idirafter = 1021,                      /* -idirafter */
  OPT_imacros = 1022,                        /* -imacros */
  OPT_imultiarch = 1023,                     /* -imultiarch */
  OPT_imultilib = 1024,                      /* -imultilib */
  OPT_include = 1025,                        /* -include */
  OPT_iplugindir_ = 1026,                    /* -iplugindir= */
  OPT_iprefix = 1027,                        /* -iprefix */
  OPT_iquote = 1028,                         /* -iquote */
  OPT_isysroot = 1029,                       /* -isysroot */
  OPT_isystem = 1030,                        /* -isystem */
  OPT_iwithprefix = 1031,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1032,              /* -iwithprefixbefore */
  OPT_k8 = 1033,                             /* -k8 */
  OPT_l = 1034,                              /* -l */
  OPT_lang_asm = 1035,                       /* -lang-asm */
  OPT_mabi_ = 1036,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1037,             /* -mabort-on-noreturn */
  ...
  OPT_mcallee_super_interworking = 1046,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1047,     /* -mcaller-super-interworking */
  OPT_mcpu_ = 1048,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1049,            /* -mfix-cortex-m3-ldrd */
  OPT_mfloat_abi_ = 1050,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1051,                  /* -mfp16-format= */
  OPT_mfpu_ = 1052,                          /* -mfpu= */
  ...
  OPT_munaligned_access = 1069,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1070,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1071,      /* -mvectorize-with-neon-quad */
  OPT_mword_relocations = 1072,              /* -mword-relocations */
  OPT_mwords_little_endian = 1073,           /* -mwords-little-endian */
  OPT_n = 1074,                              /* -n */
  OPT_no_canonical_prefixes = 1075,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1076,              /* -no-integrated-cpp */
  ...
  OPT_pie = 1089,                            /* -pie */
  OPT_pipe = 1090,                           /* -pipe */
  OPT_print_file_name_ = 1091,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1092,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1093,          /* -print-multi-directory */
  OPT_print_multi_lib = 1094,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1095,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1096,                /* -print-multiarch */
  ...
  OPT_static_libasan = 1114,                 /* -static-libasan */
  OPT_static_libgcc = 1115,                  /* -static-libgcc */
  OPT_static_libgcj = 1116,                  /* -static-libgcj */
  OPT_static_libgfortran = 1117,             /* -static-libgfortran */
  OPT_static_libgo = 1118,                   /* -static-libgo */
  OPT_static_libstdc__ = 1119,               /* -static-libstdc++ */
  OPT_static_libtsan = 1120,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1121, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1122, */                /* -std=c++0x */
  OPT_std_c__11 = 1123,                      /* -std=c++11 */
  OPT_std_c__1y = 1124,                      /* -std=c++1y */
  OPT_std_c__98 = 1125,                      /* -std=c++98 */
  OPT_std_c11 = 1126,                        /* -std=c11 */
  /* OPT_std_c1x = 1127, */                  /* -std=c1x */
  /* OPT_std_c89 = 1128, */                  /* -std=c89 */
  OPT_std_c90 = 1129,                        /* -std=c90 */
  OPT_std_c99 = 1130,                        /* -std=c99 */
  /* OPT_std_c9x = 1131, */                  /* -std=c9x */
  OPT_std_f2003 = 1132,                      /* -std=f2003 */
  OPT_std_f2008 = 1133,                      /* -std=f2008 */
  OPT_std_f2008ts = 1134,                    /* -std=f2008ts */
  OPT_std_f95 = 1135,                        /* -std=f95 */
  OPT_std_gnu = 1136,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1137, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1138, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1139,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1140,                    /* -std=gnu++1y */
  OPT_std_gnu__98 = 1141,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1142,                      /* -std=gnu11 */
  /* OPT_std_gnu1x = 1143, */                /* -std=gnu1x */
  /* OPT_std_gnu89 = 1144, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1145,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1146,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1147, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1148, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1149,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1150, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1151, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1152, */         /* -std=iso9899:2011 */
  OPT_std_legacy = 1153,                     /* -std=legacy */
  OPT_symbolic = 1154,                       /* -symbolic */
  OPT_t = 1155,                              /* -t */
  OPT_time = 1156,                           /* -time */
  OPT_time_ = 1157,                          /* -time= */
